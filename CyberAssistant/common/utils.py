...
def create_sqlsearch_agent(
    ...
    db_config = f"mysql+pymysql://{os.environ['SQL_SERVER_USERNAME']}:{os.environ['SQL_SERVER_PASSWORD']}@{os.environ['SQL_SERVER_NAME']}:{os.environ['SQL_SERVER_PORT']}/{os.environ['SQL_SERVER_DATABASE']}"
    print(f"<<<<<  {db_config}  >>>>>")
